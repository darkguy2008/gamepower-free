namespace Littera2GPK
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lbDrop.Text = "Drag a Littera ZIP file (exported in XML format) here to convert it to a GamePowe" +
    "r Package file.\r\n\r\nThe output file will end up in the same location as the origi" +
    "nal file.";
            ...
            this.Text = "Littera to GamePower Package converter";
